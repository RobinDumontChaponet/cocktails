...
class Timed {
	...
	private static function getrtime($ru, $rus, $index) {
	...
	public function printResult () {
		...
		echo 'This process used '.self::getrtime($ru, $this->start, "utime").' ms for its computations<br />';
		echo 'It spent '.self::getrtime($ru, $this->start, "stime").' ms in system calls';
	}
}
