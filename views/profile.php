<!--meta title="Profil" js="script/passwords.transit.js"-->
<style>
input, select {
	display: block;
	margin-left: auto;
...
<div id="content">
	<form method="post">
		<div>
			...
			<input type="text" readonly="readonly" id="login" value="<?= $user->getLogin() ?>" />

			<label name="email">E-mail</label>
			<input type="email" name="email" id="mail" placeholder="exemple@exemple.com" value="<?= $user->getEmail() ?>" />
		...
		<div>
			...
			<input type="date" name="birthDate" placeholder="jj/mm/aaaa" value="<?= $user->getBirthDate() ?>"/>
